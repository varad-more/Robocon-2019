...
;//! \htmlinclude accl_values.msg.html

(cl:defclass <accl_values> (roslisp-msg-protocol:ros-message)
  ((mpu_no
    :reader mpu_no
    :initarg :mpu_no
    :type cl:fixnum
...
(cl:defclass accl_values (<accl_values>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <accl_values>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'accl_values)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mpu6050_new-msg:<accl_values> is deprecated: use mpu6050_new-msg:accl_values instead.")))

(cl:ensure-generic-function 'mpu_no-val :lambda-list '(m))
(cl:defmethod mpu_no-val ((m <accl_values>))
...
(cl:defmethod ax-val ((m <accl_values>))
...
(cl:defmethod ay-val ((m <accl_values>))
...
(cl:defmethod az-val ((m <accl_values>))
  ...
  (az m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <accl_values>) ostream)
  "Serializes a message object of type '<accl_values>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <accl_values>) istream)
  "Deserializes a message object of type '<accl_values>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<accl_values>)))
  "Returns string type for a message object of type '<accl_values>"
  "mpu6050_new/accl_values")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'accl_values)))
  "Returns string type for a message object of type 'accl_values"
  "mpu6050_new/accl_values")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<accl_values>)))
  "Returns md5sum for a message object of type '<accl_values>"
  "b85bc66545609800449b146da1841ce6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'accl_values)))
  "Returns md5sum for a message object of type 'accl_values"
  "b85bc66545609800449b146da1841ce6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<accl_values>)))
  "Returns full string definition for message of type '<accl_values>"
  (cl:format cl:nil "uint8 mpu_no~%float64 ax~%float64 ay~%float64 az~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'accl_values)))
  "Returns full string definition for message of type 'accl_values"
  (cl:format cl:nil "uint8 mpu_no~%float64 ax~%float64 ay~%float64 az~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <accl_values>))
  (cl:+ 0
     1
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <accl_values>))
