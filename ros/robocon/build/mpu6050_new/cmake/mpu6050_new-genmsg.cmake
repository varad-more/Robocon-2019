...
message(STATUS "mpu6050_new: 1 messages, 1 services")

set(MSG_I_FLAGS "-Impu6050_new:/home/suraj/robocon/src/mpu6050_new/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/suraj/robocon/src/mpu6050_new/msg/accl_values.msg" NAME_WE)
add_custom_target(_mpu6050_new_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "mpu6050_new" "/home/suraj/robocon/src/mpu6050_new/msg/accl_values.msg" ""
)

get_filename_component(_filename "/home/suraj/robocon/src/mpu6050_new/srv/mpu_values.srv" NAME_WE)
add_custom_target(_mpu6050_new_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "mpu6050_new" "/home/suraj/robocon/src/mpu6050_new/srv/mpu_values.srv" ""
)
...
_generate_msg_cpp(mpu6050_new
  "/home/suraj/robocon/src/mpu6050_new/msg/accl_values.msg"
  "${MSG_I_FLAGS}"
  ""
...
_generate_srv_cpp(mpu6050_new
  "/home/suraj/robocon/src/mpu6050_new/srv/mpu_values.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/mpu6050_new
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/mpu6050_new)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/mpu6050_new\")")
  # install generated code
  install(
