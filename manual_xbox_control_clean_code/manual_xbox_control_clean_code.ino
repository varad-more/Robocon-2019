      ...
      if (Xbox.Xbox360Connected[0]) { //i
       uint8_t i = 0;
        ...
        //ANTICLOCKWISE
          ...
          //Serial.println(Vector.Direction);
...
char* calc_motor_direction(double theta)
{
  ...
  if (int_theta == 500)
  {
    ...
    if (int_theta >= -180 && int_theta < -120)
    {
      str[0] = 'l';
      str[1] = 'r';
      str[2] = 'r';
    }
    else if (int_theta >= -120 && int_theta < -60)
    {
      str[0] = 'l';
      str[1] = 'l';
      str[2] = 'r';
    }
    else if (int_theta >= -60 && int_theta < 0)
    {
      str[0] = 'r';
      str[1] = 'l';
      str[2] = 'r';
    }
    else if (int_theta >= 0 && int_theta < 60)
    {
      str[0] = 'r';
      str[1] = 'l';
      str[2] = 'l';
    }
    else if (int_theta >= 60 && int_theta < 120)
    {
      str[0] = 'r';
      str[1] = 'r';
      str[2] = 'l';
    }
    else if (int_theta >= 120 && int_theta < 180)
    {
      str[0] = 'l';
      str[1] = 'r';
      str[2] = 'l';
...
double vector_direction(uint8_t i)
{
  ...
  else
  {
    ...
    {
      angle = angle  * (180 / PI);
      angle = map(angle, 0, 90, -90, -180);
    }
    else if (Rx >= 0 && Ry < 0)
    {
      angle = angle  * (180 / PI);
      angle = map(angle, -90, 0, 180, 90);
    }
    return angle;
  }
}
