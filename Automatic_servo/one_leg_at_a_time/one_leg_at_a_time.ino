...
volatile float points_leg1[no_pointer][2] = {{-20,60},{-18,55},{-10,50},{10,50},{18,55},{20,60}}; //{{1,50 },{ -20 , 57 },{ 20 , 57 }};//, { -20, 60} };
volatile float points_leg2[no_pointer][2] = {{-20,60},{-18,55},{-10,50},{15,55},{18,55},{20,60}}; //{{-20,40}};//{{-1,50},{ 20 , 57},{ -20 , 57}};
