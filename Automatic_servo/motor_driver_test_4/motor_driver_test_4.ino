// this code is for driver receoved from robukits having direction pin ,brake pin , and pwm pin 
...
volatile float points_leg1[3][2] = {{20,60 },{ 1 , 50 },{ -20 , 60 }};//, { -20, 60} };
volatile float points_leg2[3][2] = {{-20,60},{ -1 , 50},{ 20 , 60}};
