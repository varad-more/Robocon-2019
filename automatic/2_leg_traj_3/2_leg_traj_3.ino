...
volatile bool leg_flag[4] = {false , false, false , false };
...
void walk()
{
  ...
  {
    leg1.gotopos(-20, 60);
  } while (leg_flag[0] == true);

  leg_flag[1] == true ;
  do
  {
    leg2.gotopos(20, 60);
  } while (leg_flag[1] == true);
